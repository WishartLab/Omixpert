...
#### ADD CONFLICT BETWEEN REFERENCE AND LEVEL ORDER?
    ...
    #STORE RESULTS
    mSetObj$analSet$logOrdReg$res <- list(summary = summary, model.data = model_data, response = facA, predictor = predictors, predtext = predtext1, predicted.values = fitted, confidence.intervals = conf.int, 
